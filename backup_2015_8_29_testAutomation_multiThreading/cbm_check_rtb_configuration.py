...
class CBM1(threading.Thread):
    ...
    def check_config(self):
        ...
        stream1 = open("1.txt", 'w')
        stream2 = open("2.txt", 'w')

        print "***Checking Configuration***                                     [1/5]"
        child = pexpect.spawn('telnet %s' % (self.hostname))
        log_checkConfiguration=logger("Result_All_CheckConfiguration.log",'w')
                                    ...
                                    if index == 0:
                                        ...
                                        if index == 0:
                                            ...
                                            if index == 0:
                                                ...
                                                if index == 0:
                                                    keyLog_RTB = logger("Result_RTB_InSv.log",'w')
                                                    ...
                                                    if index==0:
                                                        ...
                                                        if index == 0:
                                                            index = child.expect(["----------------------------------------------------", pexpect.EOF,pexpect.TIMEOUT], timeout=5)
                                                            if index == 0:
                                                                keyLog_ConfRTB=logger("Result_CONFRTB_CONFIGURED.log", 'w')
                                                                ...
                                                                while True:
                                                                    ...
                                                                    if index == 0:
                                                                        flag=1
                                                                        print>>stream1,child.before
                                                                        print>>stream2,child.after
                                                                    elif index == 1:
                                                                        flag=1
                                                                        print child.before
                                                                        print child.after
                                                                ...
                                                                if index==0:
                                                                    ...
                                                                    if index==0:
                                                                        child.send('list\n\r')
                                                                        keyLog_SCHEDULE = logger("Result_SCHEDULE_CONFIGURED.log", 'w')
